...
// função que cria um novo cartão de crédito
...
// função que faz a validação completa
...
// função que valida o mês de expiração do cartão
...
// função que valida o ano de expiração do cartão
